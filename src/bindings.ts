...
export type PostProcessProvider = { id: string; label: string; base_url: string; allow_base_url_edit?: boolean; requires_api_key?: boolean; models_endpoint?: string | null; supports_structured_output?: boolean }
